...
export default function HomeAboutSection() {
  return (
    <div className={`bg-white px-[10%] py-16 md:px-[15%] ${rubik.className}`}>
      <TitleBadge title={"Who We Are"} />
      <div className="mt-4 md:flex">
        <img
          className="mb-4 h-40 w-40 md:mb-0 md:mr-4"
...
const InfoCard = (props: { children: ReactNode }) => {
  return (
    <div className={`mt-[10px] text-gray-500 ${krubItalic.className}`}>
      {props.children}
    </div>
  );
};
